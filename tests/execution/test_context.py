...
class MockDLQManager:
    ...
    def add_to_dlq(self, execution_id: str, pipeline: str, params: dict, error: str, **kwargs):
...
class TestExecutionContext:
    ...
    def test_set_result(self):
        """Test setting result."""
        execution = Execution.create(pipeline="test", params={})
        ledger = MockLedger()
...
class TestTrackedExecution:
    ...
    def test_lock_acquired_and_released(self):
        ...
        assert "pipeline:test.pipeline" in guard.acquire_calls[0]["lock_key"]
