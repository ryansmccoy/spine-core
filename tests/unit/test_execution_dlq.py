...
class TestListUnresolved:
    ...
    def test_list_excludes_resolved(self, dlq):
        ...
        entry = dlq.add_to_dlq("exec-1", "workflow.a", {}, "Error")
        dlq.add_to_dlq("exec-2", "workflow.b", {}, "Error")
    ...
    def test_list_filter_by_workflow(self, dlq):
        ...
        unresolved = dlq.list_unresolved(workflow="workflow.a")
...
class TestCountUnresolved:
    ...
    def test_count_all(self, dlq):
        ...
        dlq.add_to_dlq("exec-1", "workflow.a", {}, "Error")
        dlq.add_to_dlq("exec-2", "workflow.b", {}, "Error")
        
        assert dlq.count_unresolved() == 2

    def test_count_by_workflow(self, dlq):
        """Count by workflow."""
        dlq.add_to_dlq("exec-1", "workflow.a", {}, "Error")
        dlq.add_to_dlq("exec-2", "workflow.a", {}, "Error")
        dlq.add_to_dlq("exec-3", "workflow.b", {}, "Error")
        
        assert dlq.count_unresolved(workflow="workflow.a") == 2
        assert dlq.count_unresolved(workflow="workflow.b") == 1
