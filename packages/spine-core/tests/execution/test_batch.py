...
class TestBatchItem:
    ...
    def test_create_batch_item(self):
        ...
        assert item.pipeline == "test.pipeline"
...
class TestBatchResult:
    ...
    def test_create_batch_result(self):
        ...
        now = datetime.now(timezone.utc)
        items = [
            BatchItem(id="1", pipeline="p1", params={}),
            BatchItem(id="2", pipeline="p2", params={}),
        ]
        result = BatchResult(
            batch_id="batch-123",
            items=items,
    ...
    def test_result_counts(self):
        ...
        now = datetime.now(timezone.utc)
        items = [
            BatchItem(id="1", pipeline="p1", params={}, status=ExecutionStatus.COMPLETED),
            BatchItem(id="2", pipeline="p2", params={}, status=ExecutionStatus.COMPLETED),
            BatchItem(id="3", pipeline="p3", params={}, status=ExecutionStatus.FAILED),
            BatchItem(id="4", pipeline="p4", params={}, status=ExecutionStatus.PENDING),
        ]
        result = BatchResult(
            batch_id="batch-123",
            items=items,
    ...
    def test_result_to_dict(self):
        ...
        now = datetime.now(timezone.utc)
        items = [
            BatchItem(id="1", pipeline="p1", params={"x": 1}, status=ExecutionStatus.COMPLETED),
        ]
        result = BatchResult(
            batch_id="batch-123",
            items=items,
        ...
        assert data["items"][0]["pipeline"] == "p1"
...
class TestBatchExecutor:
    ...
    def test_add_item(self):
        ...
        item_id = executor.add("pipeline_a", params={"date": "2024-01-01"})
    ...
    def test_add_multiple_items(self):
        ...
        executor.add("pipeline_a", params={"x": 1})
        executor.add("pipeline_b", params={"x": 2})
        executor.add("pipeline_c", params={"x": 3})
    ...
    def test_register_handler(self):
        """Test registering a pipeline handler."""
        ledger = MagicMock()
        executor = BatchExecutor(ledger)
        ...
        executor.register_handler("my.pipeline", my_handler)
        
        handler = executor._get_handler("my.pipeline")
    ...
    def test_get_default_handler(self):
        ...
        handler = executor._get_handler("unknown.pipeline")
...
class TestBatchBuilder:
    ...
    def test_add_single_item(self):
        ...
        builder.add("pipeline_a", params={"date": "2024-01-01"})
    ...
    def test_add_multiple_items(self):
        ...
        builder.add("pipeline_a", params={"x": 1})
        builder.add("pipeline_b", params={"x": 2})
        builder.add("pipeline_c", params={"x": 3})
    ...
    def test_handler_registration(self):
        ...
        builder = BatchBuilder(ledger).handler("my.pipeline", my_handler)
        
        assert builder._executor._get_handler("my.pipeline") is my_handler
