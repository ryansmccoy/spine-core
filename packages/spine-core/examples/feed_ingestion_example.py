"""Real-world example: Feed ingestion pipeline using spine.execution.

This example demonstrates how to use the unified execution contract
for a feed processing pipeline similar to feedspine's architecture.

Run this example:
    cd spine-core/packages/spine-core
    python examples/feed_ingestion_example.py
"""
import asyncio
import random
