"""Concurrency guard - prevents overlapping pipeline executions.

Uses database-level locking to ensure only one execution of a pipeline+params
combination runs at a time. Locks expire automatically after a timeout.
...
Example:
    ...
    >>>
    >>> if guard.acquire(lock_key, execution_id="exec-123"):
    ...     try:
    ...         # Run pipeline
    ...         pass
    ...     finally:
