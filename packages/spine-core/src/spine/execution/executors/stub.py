...
This executor is a no-op that always succeeds immediately without
executing anything. It's useful for testing dispatcher logic,
integration tests, and dry-run scenarios.
"""
import uuid
