...
class ErrorContext:
    ...
    ErrorContext has typed fields for common metadata like workflow name,
    ...
    Examples:
        ...
        >>> ctx = ErrorContext(
        ...     workflow="fetch_filings",
        ...     execution_id="abc-123",
        ...     source_name="sec_api"
        ... )
        >>> ctx.to_dict()
        {'workflow': 'fetch_filings', 'execution_id': 'abc-123', 'source_name': 'sec_api'}
