"""Core Concepts Overview — Architecture layers and design principles.

Documentation carrier module. Content is extracted by document-spine
and rendered into CONCEPTS.md as the overview section.

Manifesto:
    ## Table of Contents

    1. [Error Handling](#error-handling) — Result pattern and SpineError hierarchy
    2. [Runs, Replay & Artifacts](#runs-replay--artifacts) — Execution lifecycle and audit trail
    3. [Architecture Layers](#architecture-layers) — 5-layer design
    4. [Primitives & Execution Model](#primitives--execution-model) — Operation, Step, Workflow
    5. [Protocols](#protocols) — Connection, Result, and Executor patterns
    6. [Temporal Provenance](#temporal-provenance) — Four-timestamp model

    ---

    ## Architecture Layers

    spine-core is organized in **5 layers**, each building on the one below.
...
Tags: concepts, overview, architecture, layers
Doc-Types: CONCEPTS (priority: 15)
"""
