...
class EventDispatcher:
    ...
    Example:
        >>> from spine.execution import EventDispatcher, task_spec
    ...
    async def submit(self, spec: WorkSpec) -> str:
        ...
        try:
            ...
            await self._save_run(run)
            await self._record_event(run_id, EventType.QUEUED, {"external_ref": external_ref})
    ...
    async def submit_task(self, name: str, params: dict | None = None, **kwargs) -> str:
    ...
    async def submit_step(
        self, name: str, params: dict | None = None, parent_run_id: str | None = None, **kwargs
    ) -> str:
    ...
    async def retry(self, run_id: str) -> str:
        ...
        await self._record_event(original.run_id, EventType.RETRIED, {"new_run_id": new_run_id})
