"""Executor adapter protocol - the ONLY backend interface.

This module defines the Executor protocol that all runtime adapters must
implement. Whether using Celery, Airflow, K8s Jobs, or local threads,
the interface is the same.

The Executor is THE ONLY "backend" concept in spine-core.
"""
