...
@contextmanager
def log_step(
    event: str, log_start: bool = True, level: str = "info", **extra_metrics
...
@contextmanager
def log_pipeline_stage(stage: str, **extra) -> Iterator[TimingResult]:
    """
    ...
    Usage:
        with log_pipeline_stage("normalize", week="2025-12-20"):
