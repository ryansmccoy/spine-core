"""Real-world example: FastAPI integration with spine.execution.

This example demonstrates how to build a REST API for pipeline orchestration
using the unified execution contract, similar to what capture-spine or
market-spine would use.
