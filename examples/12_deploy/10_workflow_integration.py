...
def main() -> None:
    ...
    print(f"  has_operation_steps : {testbed_wf.has_operation_steps()}")
    ...
    print()
    print("    wf = Workflow(")
    print('        name="deploy.full_operation",')
    print("        steps=steps,")
    print('        domain="spine.deploy",')
    print("    )")
    print()
    print("  This is how you'd build a CI operation that:")
    ...
    print("    - Best for: CI operations, nightly runs, production")
