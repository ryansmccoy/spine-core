#!/usr/bin/env python3
"""Handler Registration - Registering tasks and pipelines.

This example demonstrates how to register handlers using the
HandlerRegistry and @register_task/@register_pipeline decorators.

Run: python examples/01_basics/02_handler_registration.py
"""
