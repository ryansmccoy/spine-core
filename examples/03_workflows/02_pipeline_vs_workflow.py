...
- Pipeline: Fixed series of transformations, each step transforms data
- Workflow: Flexible orchestration with conditional paths and branching

Run: python examples/03_workflows/02_pipeline_vs_workflow.py
"""
import asyncio
