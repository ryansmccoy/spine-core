...
primitives to orchestrate FeedSpine feed collection tasks.

Uses mock APIs that simulate real FeedSpine behavior.

Run: python examples/04_integration/02_feedspine_integration.py
"""
import asyncio
import sys
