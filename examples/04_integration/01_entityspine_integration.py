...
This example demonstrates how to use spine-core execution
primitives to orchestrate EntitySpine entity resolution tasks.

Uses mock APIs that simulate real EntitySpine behavior.

Run: python examples/04_integration/01_entityspine_integration.py
"""
import asyncio
import sys
