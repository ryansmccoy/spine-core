...
class TestSchemaModuleOwnership:
    ...
    def test_finra_domain_contains_only_finra_tables(self):
        ...
        finra_tables = (
            PROJECT_ROOT
            / "packages/spine-domains/src/spine/domains/finra/otc_transparency/schema/00_tables.sql"
        )
    ...
    def test_reference_domain_contains_only_reference_tables(self):
        ...
        ref_tables = (
            PROJECT_ROOT
            / "packages/spine-domains/src/spine/domains/reference/exchange_calendar/schema/00_tables.sql"
        )
    ...
    def test_generated_schema_contains_all_modules(self):
        ...
        assert generated_schema.exists(), (
            "Generated schema.sql not found (run python scripts/build_schema.py)"
        )
...
class TestSchemaModuleStructure:
    ...
    def test_finra_schema_directory_structure(self):
        ...
        finra_dir = (
            PROJECT_ROOT / "packages/spine-domains/src/spine/domains/finra/otc_transparency/schema"
        )
    ...
    def test_reference_schema_directory_structure(self):
        ...
        ref_dir = (
            PROJECT_ROOT
            / "packages/spine-domains/src/spine/domains/reference/exchange_calendar/schema"
        )
...
class TestSchemaIndexSeparation:
    ...
    def test_finra_tables_do_not_contain_indexes(self):
        ...
        assert "CREATE INDEX" not in content, (
            "Tables file should not contain CREATE INDEX statements"
        )
    ...
    def test_finra_indexes_contain_only_indexes(self):
        ...
        finra_indexes = (
            PROJECT_ROOT
            / "packages/spine-domains/src/spine/domains/finra/otc_transparency/schema/01_indexes.sql"
        )
    ...
    def test_finra_views_contain_only_views(self):
        ...
        finra_views = (
            PROJECT_ROOT
            / "packages/spine-domains/src/spine/domains/finra/otc_transparency/schema/02_views.sql"
        )
